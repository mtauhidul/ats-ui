...
export function EditJobModal({
  ...
  const transformJobToFormData = (jobData: Job): UpdateJobRequest => {
    ...
    let locationObj: { city: string; country: string } = {
      city: "",
      country: "",
    };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const validResponsibilities = (formData.responsibilities || []).filter(
      (r) => r.trim()
    );
    ...
    const validSkills = (formData.requirements?.skills?.required || []).filter(
      (s) => s.trim()
    );
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className={`h-11 ${
                            errors.locationCity ? "border-red-500" : ""
                          }`}
                        />
                        {errors.locationCity && (
                          <p className="text-sm text-red-500 flex items-center gap-1">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          placeholder="e.g., USA"
                          className={`h-11 ${
                            errors.locationCountry ? "border-red-500" : ""
                          }`}
                        />
