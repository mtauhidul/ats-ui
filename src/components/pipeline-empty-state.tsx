...
import { Plus, Sparkles, Briefcase, Code, TrendingUp, ArrowRight } from "lucide-react";
...
export function PipelineEmptyState({ onCreateCustom, onSelectTemplate }: PipelineEmptyStateProps) {
  return (
      ...
      <div className="max-w-5xl w-full space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Set up a hiring pipeline to track candidates through your recruitment process
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Custom Pipeline */}
          <Card className="border-2 hover:border-primary/50 transition-colors cursor-pointer group" onClick={onCreateCustom}>
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-sm">
                Create a completely custom pipeline with your own stages and workflow
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-2 hover:border-primary/50 transition-colors">
            ...
            <CardContent className="space-y-3">
              {Object.entries(DEFAULT_PIPELINE_TEMPLATES).map(([key, template]) => {
