    ...
    <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
      ...
      <Card className="@container/card">
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm pt-0 pb-4 border-t-0">
          ...
          <div className="text-muted-foreground leading-relaxed">Applications to review</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader className="flex-row items-start justify-between gap-4 border-b-0">
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm pt-0 pb-4 border-t-0">
          ...
          <div className="text-muted-foreground leading-relaxed">Companies hiring through us</div>
        </CardFooter>
      </Card>
    </div>
  );
